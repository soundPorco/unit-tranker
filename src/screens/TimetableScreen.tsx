...
const cm = StyleSheet.create({
    ...
    cancel: { fontSize: 17, color: '#3eb370', paddingVertical: 4, paddingHorizontal: 4 },
    save: { fontSize: 17, color: '#3eb370', fontWeight: '600', paddingVertical: 4, paddingHorizontal: 4 },
