        ...
        <ScrollView contentContainerStyle={s.scroll} keyboardShouldPersistTaps="handled">
          ...
          <View style={s.sectionHeader}>
            <View style={s.sectionIconWrap}>
              <Ionicons name="calendar-outline" size={15} color="#3eb370" />
            </View>
          ...
          <View style={[s.sectionHeader, { marginTop: 28 }]}>
            <View style={[s.sectionIconWrap, { backgroundColor: '#e6f5ee' }]}>
              <Ionicons name="grid-outline" size={15} color="#3eb370" />
            </View>
...
const s = StyleSheet.create({
  ...
  periodBtnActive: { backgroundColor: '#3eb370' },
  ...
  saveBtn: {
    backgroundColor: '#3eb370', borderRadius: 12,
