    ...
    <SafeAreaView style={s.container} edges={['top', 'bottom']}>
      <View style={s.header}>
        <TouchableOpacity
          ...
          style={s.backBtn}
        >
          <Ionicons name="chevron-back" size={26} color="#0095d9" />
        </TouchableOpacity>
        ...
        <ScrollView contentContainerStyle={s.scroll} keyboardShouldPersistTaps="handled">
          ...
          <View style={s.sectionHeader}>
            <View style={s.sectionIconWrap}>
              <Ionicons name="calendar-outline" size={15} color="#0095d9" />
            </View>
...
const s = StyleSheet.create({
  ...
  periodBtnActive: { backgroundColor: '#0095d9' },
  ...
  saveBtn: {
    backgroundColor: '#0095d9', borderRadius: 12,
