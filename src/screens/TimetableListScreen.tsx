        ...
        >
            <SafeAreaView style={modal.container}>
                <View style={modal.header}>
                    ...
                    <TouchableOpacity
                        onPress={() => onCreate(academicYear, semester)}
                    >
                        ...
                        {SEMESTER_OPTIONS.map((s) => (
                            ...
                            >
                                <Text
                                    style={[
                                        modal.segText,
                                        semester === s && modal.segTextActive,
                                    ]}
                                >
                                    {s}
                                </Text>
...
export function TimetableListScreen() {
    ...
    const { timetables, loaded, createTimetable, deleteTimetable } =
        useTimetables();
                    ...
                    renderItem={({ item }) => {
                        ...
                        return (
                            <TouchableOpacity
                                ...
                                activeOpacity={0.7}
                                onPress={() =>
                                    navigation.navigate("TimetableMain", {
                                        timetableId: item.id,
                                    })
                                }
                            >
